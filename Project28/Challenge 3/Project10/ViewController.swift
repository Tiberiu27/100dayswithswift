...
import LocalAuthentication //Don't forget to add Privacy - Face ID description for...well...FACE ID :)
import UIKit
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @objc func authenticate() {
        ...
        if context.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: &error) {
            ...
            //no biometry
            let ac = UIAlertController(title: "No biometric authentication", message: "You sure you have Face ID or Touch ID?", preferredStyle: .alert)
            ac.addAction(UIAlertAction(title: "OK", style: .default))
