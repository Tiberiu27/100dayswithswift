...
class GameScene: SKScene {
    ...
    func createFirework(xMovement: CGFloat, x: Int, y: Int) {
        //Create an SKNode as the firework container and place it in a position
        let node = SKNode()
        ...
        //Assign random color to firework
        ...
        //create a UIBezierPath that represents the movement of the firework
        let path = UIBezierPath()
        path.move(to: .zero)
        path.addLine(to: CGPoint(x: xMovement, y: 1000))
        
        //tell the container to follow path
        ...
        //add the firework to the fireworks array and scene
    ...
    func explode(firework: SKNode) {
        if let emitter = SKEmitterNode(fileNamed: "explode") {
            ...
            addChild(emitter)
            //challenge 3
            emitter.run(SKAction.sequence([SKAction.wait(forDuration: 3), SKAction.removeFromParent()]))
        }
